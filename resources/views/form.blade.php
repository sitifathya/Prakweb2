...
<form action="{{ url('hasil') }}" method="POST">
  ...
  <div class="form-group row">
    <label for="tempat,tanggal_lahir" class="col-4 col-form-label">Tempat, Tanggal Lahir</label> 
    <div class="col-8">
      <input id="tempat,tanggal_lahir" name="tempat,tanggal_lahir" placeholder="Masukkan TTL" type="text" class="form-control">
    </div>
  </div>
  <div class="form-group row">
